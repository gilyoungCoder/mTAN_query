...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        ...
        print('Iter: {}, ce_loss: {:.4f}, acc: {:.4f}, val_loss: {:.4f}, val_acc: {:.4f}, test_acc: {:.4f}, test_auc: {:.4f}'
              .format(itr, train_ce_loss/train_n, 
                      train_acc/train_n, val_loss, val_acc, test_acc, test_auc))
